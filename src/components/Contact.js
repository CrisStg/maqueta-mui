...
const Contact = () => {
  return (
    <Grid id="Contacto"container>
        ...
        <Grid md={6} xs={12} sx={{backgroundColor:"#fff", color:"#000"}}>
        ...
        <Grid md={6} xs={12} sx={{backgroundColor:"#000", color:"#fff", display:'flex', alignContent:'center', justifyContent:'center'}}>
            <Form />
        </Grid>
    </Grid>
  )
