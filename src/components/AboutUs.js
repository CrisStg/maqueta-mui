...
const AboutUs = () => {
  return (
    <Grid id="Quienes Somos" container>
        ...
        <Grid item md={6} sx={{backgroundImage: 'url(https://crisstg.github.io/demo-maqueta/img/img-1.jpg)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
